...
class Helpers {
    ...
    /**
    * Rewrite requires in modules from something like 'ca11/bg/plugins/user/adapter`
    * to `ca11/src/js/bg/plugins/user/adapter`. Within the node runtime,
    ...
    * Source: https://github.com/ca11/ca11/
    * @param {Array} sectionModules - Ca11 modules to build.
    ...
    jsPlugins(sectionModules, appSection) {
        ...
        return new Promise((resolve) => {
            ...
            const b = browserify({
                ...
                detectGlobals: false,
                paths: [
                    // Allows Browserify to resolve ca11 project root require.
                    path.join(this.settings.ROOT_DIR, '../'),
                ],
            })
    ...
    */
    scssEntry(entryPath, sourcemap = false, entryExtra = []) {
        ...
        let includePaths = [
            ...
            // ca11 directory for imports; also for the docs build.
